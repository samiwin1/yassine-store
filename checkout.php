               ...
               <div class="modal-body">
                  <form>
                     <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                           <label for="inputPassword4">Delivery Area <span class="required text-danger">*</span></label>
                        ...
                        <div class="form-group col-md-12">
                           <label for="inputPassword4">Complete Address <span class="required text-danger">*</span>
                           </label>
                           <input type="text" class="form-control" placeholder="Complete Address e.g. house number, street name, landmark">
                        </div>
                        <div class="form-group col-md-12">
                           <label for="inputPassword4">Delivery Instructions <span class="required text-danger">*</span>
                           </label>
            ...
            <div class="row">
                                          ...
                                          <div class="gold-members p-3">
                                             <div class="media">
                                                <div class="media-body">
                                                   ...
                                                   <p>Model Town Rd Delhi Bypass Rd, Jawaddi Taksal, Ludhiana, Punjab 141002, India
                                                   </p>
                                          ...
                                          <div class="gold-members p-3">
                                             <div class="media">
                                                <div class="media-body">
                                                   ...
                                                   <p class="text-secondary">Phone: <span class="text-dark">8568079956</span></p>
                                                   <button data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" type="button" class="btn btn-outline-primary btn-block">DELIVER HERE</button>
                                                   <hr>
                                                   <p class="mb-0 text-black"><a class="text-success mr-3" data-toggle="modal" data-target="#add-address-modal" href="#"><i class="icofont-ui-edit"></i> EDIT</a> <a class="text-danger" data-toggle="modal" data-target="#delete-address-modal" href="#"><i class="icofont-ui-delete"></i> DELETE</a></p>
                                                </div>
                                             </div>
                           ...
                           <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                              <div class="card-body p-0">
                                 <div class="cart-table">
                                          ...
                                          <tbody>
                                             <tr>
                                                ...
                                                <td class="cart_description">
                                                   ...
                                                   <hr>
                                                   <a class="text-info" href="#"><i class="icofont-heart"></i> Move to Shortlist</a> &nbsp; &nbsp; <a class="text-danger" href="#"><i class="icofont-trash"></i> Remove Item</a>
                                                </td>
                                                <td>
                                                   <p class="text-secondary"><i class="icofont-check-circled"></i> 17 Aug to 19 Aug <span class="text-dark">+$. 49</span></p>
                                                </td>
                                                <td class="qty">
                                                ...
                                                <td class="price">
                                                   <p class="f-14 mb-0 text-dark">$250.00<br> <del class="small text-secondary">$ 500.00 </del></p>
                                                </td>
                                             </tr>
                                             <tr>
                                    ...
                                    <button data-toggle="collapse" data-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour" class="btn btn-primary btn-lg btn-block text-left" type="button"><span class="float-left"><i class="icofont icofont-cart"></i> PROCEED TO PAYMENT </span><span class="float-right"><strong>$1200.69</strong> <span class="icofont icofont-bubble-right"></span></span></button>
                                 </div>
                              </div>
                           </div>
                        </div>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4 pr-0">
                                       <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                          ...
                                          <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="icofont-id-card"></i> Shop Cards</a>
                                             ...
                                             <form>
                                                <div class="form-row">
                                                   ...
                                                   <div class="form-group col-md-12 mb-0">
                                                      <a href="thanks.html" class="btn btn-primary btn-block btn-lg">PAY $1329
               ...
               <div class="col-md-4">
                  <div class="osahan-cart-item">
                     <h5 class="mb-3 mt-0 text-dark">Summary <span class="small text-success">(5 Item)</span></h5>
                     <div class="bg-white rounded shadow-sm mb-3">
                        ...
                        <div class="cart-list-product border-0">
                           ...
                           <h5><a href="#">Floret Printed Ivory Skater Dress</a></h5>
                           <div class="stars-rating"><i class="icofont icofont-star active"></i><i class="icofont icofont-star active"></i><i class="icofont icofont-star active"></i><i class="icofont icofont-star active"></i><i class="icofont icofont-star"></i> <span>613</span></div>
                           <p class="f-14 mb-0 text-dark float-right">$900.00 <del class="small text-secondary">$ 500.00 </del></p>
                           <p class="f-12 text-secondary float-left quantity-text">Quantity: 1</p>
                        </div>
                     </div>
                     <div class="mb-3 bg-white rounded shadow-sm p-3 clearfix">
                        ...
                        <hr />
                        <h6 class="font-weight-bold text-danger mb-0">TO PAY  <span class="float-right">$1329</span></h6>
                     </div>
                  </div>
                  <div class="text-info">
